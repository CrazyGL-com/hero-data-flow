...
function DataFlowHero(props) {
    const { size, input, seed, reducedMotion, rootRef, 
    // Screenshot
    screenshot = 'https://crazygl.com/samples/screenshot-dashboard-dark.avif', screenAspect = 1.6, screenScale = 1.5, screenTilt = 10, screenBrightness = 0.25, screenshotX = 0, screenshotY = 0, 
    // Flow
    ...
    // Layout
    contentAlign = 'start', paddingX = 64, paddingY = 48, } = props;
    ...
    return (_jsxs(_Fragment, { children: [_jsx("crazygl-stage", { style: {
                    ...
                    background: `radial-gradient(ellipse at center, ${hexMix(bgTop, '#ffffff', 0.07)} 0%, ${bgTop} 45%, ${bgBottom} 100%)`,
                }, children: mounted ? (_jsx(React.Suspense, { fallback: null, children: _jsx(FlowStage, { rootRef: rootRef, size: size, input: input, seed: seed, reducedMotion: reducedMotion, screenshot: screenshot, screenAspect: screenAspect, screenScale: screenScale, screenTilt: screenTilt, screenBrightness: screenBrightness, screenshotX: screenshotX, screenshotY: screenshotY, particleCount: particleCount, particleColor: particleColor, accentColor: accentColor, flowSpeed: flowSpeed, particleSize: particleSize, emissionRate: emissionRate, showLines: showLines, lineOpacity: lineOpacity, lineMaxDistance: lineMaxDistance, cursorAttract: cursorAttract, cursorBurst: cursorBurst, ambientStars: ambientStars }) })) : null }), _jsx("crazygl-content", { style: {
                    position: 'absolute',
                    inset: 0,
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    ...align,
                }, children: _jsx("div", { className: "crazygl-df-content", children: content.node }) })] }));
}
...
export default function DataFlow(props) {
    return _jsx(CrazyGLWrapper, { hero: DataFlowHero, metadata: metadata, ...props });
}
